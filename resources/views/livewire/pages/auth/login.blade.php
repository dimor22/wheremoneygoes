...
<div>
    ...
    <form method="POST" action="{{ route('login.submit') }}" wire:submit="login">
        @csrf
        <!-- Email Address -->
        <div>
        ...
        <div class="block mt-4">
            <label for="remember" class="inline-flex items-center">
                <input wire:model="form.remember" id="remember" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 text-black" name="remember">
